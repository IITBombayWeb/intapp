...
class PaypalIPN {
  ...
  /**
   * Sets the IPN verification to sandbox mode.
   *
   * (for use when testing, should not be enabled in production).
   */
  ...
  public function verifyIPN() {
    ...
    foreach ($raw_post_array as $keyval) {
      ...
      if (count($keyval) == 2) {
        ...
        string to be encoded to a space,
    ...
    /* This is often required if the server is missing a global cert bundle,
    or is using an outdated one. */
