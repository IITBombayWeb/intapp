...
class WorkflowMailSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['mail_config_admin'] = array(
      '#type'  => 'details',
      '#title' => t('Mail settings - Admin'),
      '#open' => TRUE,
    );
    
    $form['mail_config_admin']['send_mail_admin'] = array(
      '#type' => 'checkbox',
    ...
    $form['mail_config_admin']['mail_subject_admin'] = array(
      '#type' => 'textfield',
    ...
    $form['mail_config_user'] = array(
      '#type'  => 'details',
      '#title' => t('Mail settings - User'),
      '#open' => TRUE,
    );

    $form['mail_config_user']['send_mail_user'] = array(
      '#type' => 'checkbox',
    ...
    $form['mail_config_user']['mail_subject_user'] = array(
      '#type' => 'textfield',
      '#title' => t('Mail subject'),
      '#description' => t('The value in this textbox will be subject of the email'),
     ...
     $form['test_mail_option']['send_to'] = array(
      '#type' => 'textfield',
      '#title' => t('To'),
      '#description' => t('Test mail send to mail id which entered in the text box'),
