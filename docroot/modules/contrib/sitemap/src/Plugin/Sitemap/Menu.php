...
class Menu extends SitemapBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $form['show_disabled'] = array(
      ...
      '#description' => $this->t('When enabled, disabled menu links will also be shown.'),
    );
  ...
  public function view() {
    ...
    $tree = \Drupal::service('sitemap.menu.link_tree')->load($menu_id, new MenuTreeParameters());
    $manipulators = [
      ['callable' => 'menu.default_tree_manipulators:checkAccess'],
      ['callable' => 'menu.default_tree_manipulators:generateIndexAndSort'],
    ];
    $tree = \Drupal::service('sitemap.menu.link_tree')->transform($tree, $manipulators);
    ...
    $menu_display = \Drupal::service('sitemap.menu.link_tree')->buildForSitemap($tree);
